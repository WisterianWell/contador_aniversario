...
const dataDoEvento = new Date("Dec 01, 2024 20:00:00");
...
const contaAsHoras = setInterval(function() {
    ...
    document.getElementById('contador').innerHTML = `será em ${diasAteEvento}d ${horasAteEvento}h ${minutosAteEvento}m ${segundosAteEvento}s`
